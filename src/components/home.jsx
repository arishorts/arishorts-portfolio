      ...
      <div className="row mt-5">
        <div className="col-12 col-lg-8 d-flex align-items-center pe-sm-5 px-3">
          <section className="ps-sm-5 p-3 pt-5">
            ...
            <h3 className="home-subheader fs-1 fw-bold">Fullstack Developer</h3>
            <p className="pt-3 home-content fs-2 fw-bold">
              ...
              and a passion for cutting-edge technologies, I build robust
              back-end systems for customer-oriented interfaces with dynamic
              front-end interactions. Join me on this journey as I pursue an
              enriching career, one line of code at a time.
            </p>
          </section>
        </div>
